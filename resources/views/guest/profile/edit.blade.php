        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4 mb-4">
                            ...
                            <div class="button-wrapper">
                                ...
                                @if($user->photo)
                                <form action="{{ route('guest.profile.remove-photo') }}" method="POST" class="d-inline mt-2">
                                    @csrf
                    ...
                    <div class="card-body">
                        <form id="formAccountSettings" action="{{ route('guest.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
