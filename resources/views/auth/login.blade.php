                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <small>Login dengan akun demo:</small>
                            <div class="d-flex justify-content-center gap-2 mt-2">
                                <span class="badge bg-label-primary">Admin: admin@gmail.com</span>
                                <span class="badge bg-label-info">Password: password</span>
                            </div>
                        </div>
                    </div>
                </div>
